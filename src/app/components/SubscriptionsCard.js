...
const plans = [
  ...
  <div className="max-w-6xl mx-auto">
    <div className="text-center mb-4">
      <h2 className="text-3xl font-bold text-black mb-1">CardNest Subscriptions Plans</h2>
      <p className="text-gray-400 text-base">Protect your transactions with AI-powered card fraud detection</p>
    </div>
